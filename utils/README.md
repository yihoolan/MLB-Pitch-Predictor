...
| `enrichment.py` | Pulls prior-year pitcher and batter arsenal stats from pybaseball, pivots them wide, and merges onto a raw Statcast DataFrame for offline training data preparation. |
